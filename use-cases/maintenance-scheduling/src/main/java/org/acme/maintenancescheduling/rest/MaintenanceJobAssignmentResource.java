...
@ResourceProperties(path = "jobAssignments")
public interface MaintenanceJobAssignmentResource extends PanacheRepositoryResource<MaintenanceJobAssignmentRepository, MaintenanceJobAssignment, Long> {
