...
/**
 * Like {@link RoadLocation}, but for high scale problems to avoid the memory
 * issue of keeping the entire cost matrix in memory. Used with
 * {@link DistanceType#SEGMENTED_ROAD_DISTANCE}.
 */
